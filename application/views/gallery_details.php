...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="main">
            ...
            <div class="breadcrumb-section">
            	<div class="container">
                    ...
                    <div class="breadcrumb">
                        <a href="<?php echo site_url('home_controller/gallery/');?>">Back</a>
                        <span class="fa fa-angle-double-right"></span>
                        <span class="current">Gallery Details</span>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
            	<!--primary starts-->
            	<section id="primary" class="content-full-width gallery_details_page">
                    ...
                    <div class="dt-sc-portfolio-container">
                        ...
                        <div class="portfolio dt-sc-one-fourth column all music">
                            <div class="portfolio-thumb">
                                ...
                                <img src="<?php echo $URL.'upload_document/'.$img->IMAGE_URL; ?>" alt="" title="">
                                <div class="image-overlay">
                                    <a href="<?php echo $URL.'upload_document/'.$img->IMAGE_URL; ?>" data-gal="prettyPhoto[gallery]" class="zoom"><span class="fa fa-search"></span></a>
                                </div>
                            </div>
